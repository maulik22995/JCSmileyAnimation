package com.sentimatedetactionsample.particleflow.particle
...
import com.sentimatedetactionsample.particleflow.core.add
import com.sentimatedetactionsample.particleflow.core.roundTo
import com.sentimatedetactionsample.particleflow.core.scalarMultiply
...
internal class Particle constructor(
    ...
    fun update(dt: Float, color: Color) {
        this.color = color
